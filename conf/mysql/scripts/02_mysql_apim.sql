...
-- REPLACED: See corrected table definition at end of file
-- Original IDP_AUTHENTICATOR table was missing columns required by WSO2 IS 7.1.0
-- REPLACED: See corrected table definition at end of file
-- REPLACED: See corrected table definition at end of file
-- REPLACED: See corrected table definition at end of file
-- REPLACED: See corrected table definition at end of file
...
-- ========================================================================
-- WSO2 Identity Server 7.1.0 Required Tables
-- ========================================================================
-- These tables and columns are required by WSO2 IS 7.1.0 but were missing
-- from the original schema. Added to fix database initialization issues.
-- ========================================================================

-- Drop and recreate IDP_AUTHENTICATOR with required columns for WSO2 IS 7.1.0
...
CREATE TABLE IF NOT EXISTS IDP_AUTHENTICATOR (
    ...
    IS_ENABLED CHAR (1) DEFAULT '1',
    DISPLAY_NAME VARCHAR(255),
    DEFINED_BY VARCHAR(25) NOT NULL DEFAULT 'SYSTEM',
    AUTHENTICATION_TYPE VARCHAR(25) NOT NULL DEFAULT 'STANDARD',
    PRIMARY KEY (ID),
    UNIQUE (TENANT_ID, IDP_ID, NAME),
    FOREIGN KEY (IDP_ID) REFERENCES IDP(ID) ON DELETE CASCADE
) ENGINE INNODB;

-- Recreate dependent tables that were dropped
CREATE TABLE IF NOT EXISTS IDP_AUTHENTICATOR_PROPERTY (
    ID INTEGER AUTO_INCREMENT,
    TENANT_ID INTEGER,
    AUTHENTICATOR_ID INTEGER,
...
-- API Resource Management Tables (Required by WSO2 IS 7.1.0)
...
-- End of WSO2 IS 7.1.0 required tables
