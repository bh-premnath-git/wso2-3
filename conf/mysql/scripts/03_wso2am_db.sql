-- WSO2AM_DB initialization
-- This database is used by both WSO2 IS (IS-AS-KM) and WSO2 APIM
-- Contains:
-- 1. Identity tables (from wso2is-7.1.0/dbscripts/identity/mysql.sql)
-- 2. Consent tables (from wso2is-7.1.0/dbscripts/consent/mysql.sql)
-- 3. Workflow tables (from wso2am-4.6.0/dbscripts/apimgt/mysql.sql - APIM-specific)
-- 4. APIM tables (from wso2am-4.6.0/dbscripts/apimgt/mysql.sql)

USE WSO2AM_DB;

-- ========================================
-- Part 1: WSO2 IS Identity Tables
-- Source: wso2is-7.1.0/dbscripts/identity/mysql.sql
-- ========================================
...
-- ========================================
-- Part 2: WSO2 IS Consent Tables
-- Source: wso2is-7.1.0/dbscripts/consent/mysql.sql
-- ========================================
...
-- ========================================
-- Part 3: WSO2 Workflow Tables (APIM-specific)
-- Source: wso2am-4.6.0/dbscripts/apimgt/mysql.sql (lines 729-806)
-- ========================================
...
-- ========================================
-- Part 4: WSO2 APIM Tables
-- Source: wso2am-4.6.0/dbscripts/apimgt/mysql.sql (from line 1462)
-- ========================================
...
-- CREATE INDEX IDX_IAT_TI_CK ON IDN_INVALID_TOKENS -- Table not present when using dedicated IS-AS-KM (TOKEN_IDENTIFIER, CONSUMER_KEY);
